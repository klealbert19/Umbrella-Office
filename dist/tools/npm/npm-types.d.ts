 ...
 */
export type NpmOperationType = 'npm.install' | 'npm.run' | 'npm.test' | 'npm.build' | 'npm.exec';
...
export type NpmPayload = NpmInstallPayload | NpmRunPayload | NpmTestPayload | NpmBuildPayload | NpmExecPayload;
...
export declare function createNpmTask(type: NpmOperationType, payload: NpmPayload): NpmTask;
